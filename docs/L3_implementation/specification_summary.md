...
repo 再観測前に G-2 で `docs/init-docs-<YYYYMMDD>` 作業ブランチを作成または切り替え、そのブランチ上で `docs/.ai/repo.profile.json` 生成、L0-L3 docs 生成、整合性検証、README scaffold 確認、CLAUDE.md 更新を行う。Phase 7 はユーザー確認後に作業ブランチ確認、commit、draft PR 作成を行う。

根拠: `commands/init-docs.md:21-43`, `commands/init-docs.md:284-329`
