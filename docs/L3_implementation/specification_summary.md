...
repo 再観測、local tooling 観測、`docs/.ai/repo.profile.json` 生成、L0-L3 docs 生成、整合性検証、README scaffold 確認、CLAUDE.md / AGENTS.md 更新、ユーザー確認後の branch/commit/draft PR 作成を定義する。
...
根拠: `commands/init-docs.md:1-370`
